...
var viewTaskDashboardCtrl = function viewTaskDashboardCtrl(uibModal, _list) {
    return new Promise(function (resolve, reject) {

        var modalInstance = uibModal.open({
            templateUrl: 'ecma5/ExternalLiberary/Dashboard/viewTaskDashboard.html?dev=' + randomVersionName,
