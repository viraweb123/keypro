...
var cutFolderAdminCtrl = function cutFolderAdminCtrl($scope, service, JSManagement, CSSManagement, toaster, $uibModal, userInfoService, Authentication) {
                    ...
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                                ...
                                case 12:
                                    _context.next = 14;
                                    return service.folder.cut(currentNode.uuid, response.addNode.id);
