...
var advanceAddTemplatesSearchAdvanceCtrl = function advanceAddTemplatesSearchAdvanceCtrl($scope, advanceService, JSManagement, CSSManagement, toaster, $uibModal, $translate) {
    return new Promise(function (resolve, reject) {
        var _this = this;

        try {
            $scope.func.advanceAddTemplatesSearch = function () {
                    ...
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                                ...
                                case 9:
                                    _context.next = 11;
                                    return selectTemplateCtrl($uibModal, JSManagement, advanceService, 'getTemplatesFolder', item.path);
                                ...
                                case 14:
                                    ...
                                    advanceService.document.createFromTemplate(result).then(function (res) {
