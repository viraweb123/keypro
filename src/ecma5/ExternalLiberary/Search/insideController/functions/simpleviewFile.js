...
var simpleviewFileSimpleCtrl = function simpleviewFileSimpleCtrl($scope, simpleService, JSManagement, CSSManagement, toaster, $uibModal, $translate) {
    return new Promise(function (resolve, reject) {
        var _this = this;

        try {
            $scope.func.simpleviewFile = function () {
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                ...
                                case 6:
                                    ...
                                    _context.prev = 7;
                                    _context.next = 10;
                                    return viewerFolderFunction($uibModal, JSManagement, CSSManagement, simpleService, { uuid: doc.uuid, type: 'document' }, $scope.data.profile);
                                ...
                                case 19:
                                    ...
                                    _context.prev = 20;
                                    _context.next = 23;
                                    return viewerFolderFunction($uibModal, JSManagement, CSSManagement, simpleService, { uuid: doc.uuid, type: 'folder' }, $scope.data.profile);
