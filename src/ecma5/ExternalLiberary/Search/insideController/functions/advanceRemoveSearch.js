...
var advanceRemoveSearchAdvanceCtrl = function advanceRemoveSearchAdvanceCtrl($scope, advanceService, JSManagement, CSSManagement, toaster, $uibModal, $translate) {
    return new Promise(function (resolve, reject) {
        var _this = this;

        try {
            $scope.func.advanceRemoveSearch = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 9:
                                ...
                                _context.prev = 14;
                                _context.next = 17;
                                return advanceService.folder.remove(item.uuid);
                            ...
                            case 31:
                                ...
                                _context.prev = 32;
                                _context.next = 35;
                                return advanceService.document.remove(item.uuid);
