...
var selectThesaurusChild = function selectThesaurusChild(uibModal, repository, rootPath, _folder, _treeType, _getNameFromPath) {
    return new Promise(function (resolve, reject) {

        var modalInstance = uibModal.open({
            templateUrl: 'ecma5/ExternalLiberary/Public/selectThesaurusChild.html?dev=' + randomVersionName,
            controller: function controller($scope, $uibModalInstance, root, folder, getNameFromPath, treeType) {
