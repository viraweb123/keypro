...
var multiCopy2DesktopCtrl = function multiCopy2DesktopCtrl(uibModal, repository, rootPath, _folder, _treeType) {
    return new Promise(function (resolve, reject) {

        var modalInstance = uibModal.open({
            templateUrl: 'ecma5/ExternalLiberary/Desktop/multiCopy2Desktop.html?dev=' + randomVersionName,
                                    ...
                                    if (_.has(res, 'uuid') || _.has(res, 'id')) {
                                        ...
                                        if (_.findIndex($scope.data.copyTree.currentNode.children, function (child) {
                                            ...
                                            $scope.data.copyTree.currentNode.children.push({
                                                ...
                                                label: typeof res.path === "string" ? res.path.split("/").pop() : "",
