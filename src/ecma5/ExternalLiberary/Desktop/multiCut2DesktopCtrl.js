...
var multiCut2DesktopCtrl = function multiCut2DesktopCtrl(uibModal, repository, rootPath, _folder, _treeType) {
    return new Promise(function (resolve, reject) {

        var modalInstance = uibModal.open({
            templateUrl: 'ecma5/ExternalLiberary/Desktop/multiCut2Desktop.html?dev=' + randomVersionName,
