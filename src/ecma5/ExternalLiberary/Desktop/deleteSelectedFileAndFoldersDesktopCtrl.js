...
var deleteSelectedFileAndFoldersDesktopCtrl = function deleteSelectedFileAndFoldersDesktopCtrl(uibModal) {
    return new Promise(function (resolve, reject) {

        var modalInstance = uibModal.open({
            templateUrl: 'ecma5/ExternalLiberary/Desktop/deleteSelectedFileAndFoldersDesktop.html?dev=' + randomVersionName,
