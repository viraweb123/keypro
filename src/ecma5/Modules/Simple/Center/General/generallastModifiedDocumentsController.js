...
var generallastModifiedDocumentsController = function generallastModifiedDocumentsController($scope, dashboardService) {
    var _this = this;
...
generallastModifiedDocumentsController.$inject = ['$scope', 'dashboardService'];