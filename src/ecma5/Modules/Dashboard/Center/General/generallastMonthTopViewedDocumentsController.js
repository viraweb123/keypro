...
var generallastMonthTopViewedDocumentsController = function generallastMonthTopViewedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, generallastMonthTopViewedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getLastMonthTopModifiedDocuments").then(function () {
...
exports.default = generallastMonthTopViewedDocumentsController;


generallastMonthTopViewedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];