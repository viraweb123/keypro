...
var generallastWeekTopModifiedDocumentsController = function generallastWeekTopModifiedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, generallastWeekTopModifiedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getLastWeekTopModifiedDocuments").then(function () {
...
exports.default = generallastWeekTopModifiedDocumentsController;


generallastWeekTopModifiedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];