...
var generallastMonthTopModifiedDocumentsController = function generallastMonthTopModifiedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, generallastMonthTopModifiedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getLastModifiedDocuments").then(function () {
...
exports.default = generallastMonthTopModifiedDocumentsController;


generallastMonthTopModifiedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];