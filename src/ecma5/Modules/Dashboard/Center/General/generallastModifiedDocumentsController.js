...
var generallastModifiedDocumentsController = function generallastModifiedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, generallastModifiedDocumentsController);
...
exports.default = generallastModifiedDocumentsController;


generallastModifiedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];