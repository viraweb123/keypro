...
var generallastWeekTopViewedDocumentssController = function generallastWeekTopViewedDocumentssController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, generallastWeekTopViewedDocumentssController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            $scope.data.isGetThumbnailsRequest = false;
            dashboardService.dashboard.getList("getLastWeekTopDownloadedDocuments").then(function () {
...
exports.default = generallastWeekTopViewedDocumentssController;


generallastWeekTopViewedDocumentssController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];