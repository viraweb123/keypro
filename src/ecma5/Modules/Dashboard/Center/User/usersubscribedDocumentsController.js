...
var usersubscribedDocumentsController = function usersubscribedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, usersubscribedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getUserSubscribedDocuments").then(function () {
...
exports.default = usersubscribedDocumentsController;


usersubscribedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];