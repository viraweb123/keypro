...
var userlastModifiedDocumentsController = function userlastModifiedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, userlastModifiedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getUserLastModifiedDocuments").then(function () {
...
exports.default = userlastModifiedDocumentsController;


userlastModifiedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];