...
var userlastUploadedDocumentsController = function userlastUploadedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, userlastUploadedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getUserLastUploadedDocuments").then(function () {
...
exports.default = userlastUploadedDocumentsController;


userlastUploadedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];