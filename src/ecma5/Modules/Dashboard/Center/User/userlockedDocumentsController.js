...
var userlockedDocumentsController = function userlockedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, userlockedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getUserLockedDocuments").then(function () {
...
exports.default = userlockedDocumentsController;


userlockedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];