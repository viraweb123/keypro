...
var userlastDownloadedDocumentsController = function userlastDownloadedDocumentsController($scope, $state, dashboardService, toaster) {
    var _this = this;

    _classCallCheck(this, userlastDownloadedDocumentsController);
    ...
    $scope.func.todo = function () {
        try {
            ...
            dashboardService.dashboard.getList("getUserLastDownloadedDocuments").then(function () {
...
exports.default = userlastDownloadedDocumentsController;


userlastDownloadedDocumentsController.$inject = ['$scope', '$state', 'dashboardService', 'toaster'];