                                            ...
                                            case 5:
                                                ...
                                                if (_.has(item, 'variables')) {
                                                    ...
                                                    _.forEach(item.variables, function (property, key) {
                                                        ...
                                                        if (_.has(item.form, key) && _.has(item.form[key], 'value')  && !_.includes(['simple', 'multiple'], _.has(item.form[key].type))) {
 																item.form[key].value =  property.value;
															if( property.value == "true" ){
																item.form[key].value = true;
															}
															if( property.value == "false" ){
																item.form[key].value = false;
															}
                                                        }
                                                    });
                ...
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        ...
                        case 4:
                            ...
                            viewStatusDashboardCtrl($uibModal, dashboardService, "/KeydocPro/services/rest/workflow/getProcessDefinitionImage?pdId=" + item.processInstance.processDefinition.id + "&node=" + item.token.node + "&authId=" + decodeURIComponent(isCookieFunction("Authorization").replace("Basic", "").trim()) + "&date=" + new Date().getTime());
                            _context10.next = 11;
                            break;
