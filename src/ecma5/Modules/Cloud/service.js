...
var CloudService = function () {
    function CloudService(Restangular, $q) {
    ...
    _createClass(CloudService, [{
        ...
        key: 'CloudServiceFactory',
        value: function CloudServiceFactory(Restangular, $q) {
            'ngInject';

            return new CloudService(Restangular, $q);
        }
    }]);
...
exports.default = CloudService.CloudServiceFactory;