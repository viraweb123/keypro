                            ...
                            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                                while (1) {
                                    switch (_context3.prev = _context3.next) {
                                        ...
                                        case 2:
                                            _context3.next = 4;
                                            return createNewUserInformations($uibModal, JSManagement, administrationService, _.map(_.map($scope.data.users, "UserId"), function (user) {
                                                return user.toLowerCase();
                                            }) // _.map($scope.data.users, "UserId")
                                            );
                                                    ...
                                                    while (1) {
                                                        switch (_context2.prev = _context2.next) {
                                                            case 0:
                                                                ...
                                                                $scope.data.users = $scope.data.users == null ? [] : $scope.data.users;
    ...
    $scope.func.todo = function () {
        try {
            ...
            administrationService.auth.getUserWithRole().then(function () {
                ...
                return toaster.pop('error', '', 'مشکلی در دریافت لیست کاربران به وجود آمده است.');
            });
        } catch (e) {
            console.error(e);
        }
