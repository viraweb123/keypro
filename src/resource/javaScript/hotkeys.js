  ...
  angular.module('cfp.hotkeys', []).provider('hotkeys', ['$injector', function($injector) {
    ...
    this.$get = ['$rootElement', '$rootScope', '$compile', '$window', '$document', function ($rootElement, $rootScope, $compile, $window, $document) {
      ...
      function _add (combo, description, callback, action, allowIn, persistent) {
        ...
        // any items added through the general API are for controllers
    ...
    return {
      ...
      controller : function($scope, $rootScope, $element) {
        ...
        setTimeout(function(){
          ...
          _.each($scope.eventList,function(v,k){
            ...
            hotkeys.add({
              ...
              callback: v
              //action: 'keypress'//v.action,//keypress, keydown or keyup
              //allowIn: allowIn
            });
      ...
      /*link: function (scope, el, attrs) {
        ...
        //console.log(scope.$eval(attrs.hotkey));

        /!*angular.forEach(scope.$eval(attrs.hotkey), function (func, hotkey) {

         console.log(attrs.hotkey);
         // split and trim the hotkeys string into array
         allowIn = typeof attrs.hotkeyAllowIn === "string" ? attrs.hotkeyAllowIn.split(/[\s,]+/) : [];

         console.log(scope.$eval(func));
        ...
        /!*for (var event in scope.funcList) {
          console.log(event);
          console.log(scope.funcList[event]);
        }*!/
